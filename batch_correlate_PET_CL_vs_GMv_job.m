...
matlabbatch{4}.spm.stats.results.export{2}.tspm.basename = 'none_p0.005_k100';
matlabbatch{5}.cfg_basicio.var_ops.cfg_save_vars.name = 'XPM_pos_none_p005_k100';
...
matlabbatch{6}.spm.stats.results.conspec.extent = 100;
...
matlabbatch{6}.spm.stats.results.export{2}.tspm.basename = 'none_p0.005_k100';
matlabbatch{7}.cfg_basicio.var_ops.cfg_save_vars.name = 'XPM_neg_none_p005_k100';
